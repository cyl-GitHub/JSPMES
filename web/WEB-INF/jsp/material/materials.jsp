...
<div style="float: left">
    ...
    <form action="/material/selectMaterialsByName" method="post">
        <div style="float: left">
    ...
    <a href="/material/selectAllMaterials">显示全部</a>
...
<table class="table table-bordered">
    ...
    <c:forEach items="${materials}" var="material">
        <tr>
            ...
            <td>
                <a href="/process/deletePm?id=${material.id}&pageNumber=${pageNumber}">删除</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
